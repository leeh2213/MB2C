            ...
            with torch.no_grad():
                ...
                for i, (veeg, vimg) in enumerate(self.val_dataloader):
                    ...
                    if total_val_loss <= self.best_loss_val:
                        ...
                        torch.save(self.Enc_eeg.state_dict(), 'model/best_checkpoints_seed42/' + model_idx + str(self.nseed) +str(self.nSub) + 'Enc_eeg_cls.pth')
                        torch.save(self.Proj_eeg.state_dict(), 'model/best_checkpoints_seed42/' + model_idx + str(self.nseed) +str(self.nSub) + 'Proj_eeg_cls.pth')
                        torch.save(self.Proj_img.state_dict(), 'model/best_checkpoints_seed42/' + model_idx + str(self.nseed) +str(self.nSub) + 'Proj_img_cls.pth')
                        torch.save(self.netG.state_dict(), 'model/best_checkpoints_seed42/' + model_idx + str(self.nseed) +str(self.nSub) + 'netG_cls.pth')
                        torch.save(self.netG2.state_dict(), 'model/best_checkpoints_seed42/' + model_idx + str(self.nseed) +str(self.nSub) + 'netG2_cls.pth')
                        ...
                        self.log_write.write('Epoch %d: , top1_200: %.4f ,top3_200: %.4f ,top5_200: %.4f\n'%((epoch + 1), top1 ,top3,top5))
                        ...
                        self.log_write.write('Epoch %d: , top1_50: %.4f ,top3_50: %.4f ,top5_50: %.4f\n'%((epoch + 1), top1_50 ,top3_50, top5_50))
...
def main():
    ...
    for j in range(1):
        ...
        # for i in range(5,10):
            ...
            Acc, Acc3, Acc5, Acc_50, Acc3_50, Acc5_50 = ie.train(args)
