...
class Generator4Embeds:
    ...
    def __init__(self, num_inference_steps=1, device='cuda') -> None:
        ...
        pipe = DiffusionPipeline.from_pretrained("image_reconstruction/MB2C_SDXL/sdxl-turbo", torch_dtype=torch.float16, variant="fp16")
        ...
        pipe.load_ip_adapter(
            "image_reconstruction/MB2C_SDXL/h94/IP-Adapter", subfolder="sdxl_models", 
